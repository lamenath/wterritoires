...
/**
 * Competence filter form base class.
 *
 * @package    rrr
 * @subpackage filter
 ...
 */
abstract class BaseCompetenceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('competence_filters[%s]');
  ...
  public function addEventListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('EventCompetence.event_id', $values)
    ;
  }
  ...
  public function addStructureListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('StructureCompetence.structure_id', $values)
    ;
  }
  ...
  public function addProjetListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('ProjetCompetence.projet_id', $values)
    ;
  }
