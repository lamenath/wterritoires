...
/**
 * CommentaireVote filter form base class.
 *
 * @package    rrr
 * @subpackage filter
 ...
 */
abstract class BaseCommentaireVoteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('commentaire_vote_filters[%s]');
