 ...
 * @method SegmentFiliere setId()         Sets the current record's "id" value
 * @method SegmentFiliere setSegmentId()  Sets the current record's "segment_id" value
 * @method SegmentFiliere setFiliereId()  Sets the current record's "filiere_id" value
 * @method SegmentFiliere setSegment()    Sets the current record's "Segment" value
 * @method SegmentFiliere setFiliere()    Sets the current record's "Filiere" value
 * 
 * @package    rrr
 * @subpackage model
 ...
 */
abstract class BaseSegmentFiliere extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('segment_filiere');
