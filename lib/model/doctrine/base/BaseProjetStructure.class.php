 ...
 * @method ProjetStructure setId()           Sets the current record's "id" value
 * @method ProjetStructure setProjetId()     Sets the current record's "projet_id" value
 * @method ProjetStructure setStructureId()  Sets the current record's "structure_id" value
 * @method ProjetStructure setProjet()       Sets the current record's "Projet" value
 * @method ProjetStructure setStructure()    Sets the current record's "Structure" value
 * 
 * @package    rrr
 * @subpackage model
 ...
 */
abstract class BaseProjetStructure extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('projet_structure');
