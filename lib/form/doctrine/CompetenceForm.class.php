 ...
 */
class CompetenceForm extends BaseCompetenceForm
{
	...
	protected function doSave($con = null)
	{
		...
		if($ids = sfContext::getInstance()->getRequest()->getPostParameter("competence[replace_list]"))
		{
			$rpl = array("ProjetCompetence", "ProfilCompetence", "EventCompetence", "StructureCompetence", "AnnonceCompetence");
			RRR::replace_relation("Competence", $this->getObject()->get("id"), $ids[0], $rpl);
			sfContext::getInstance()->getController()->redirect("/backend.php/competence/".$ids[0]."/edit");
		}
	}
}
