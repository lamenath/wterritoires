...
/**
 * EventTheme form base class.
 *
 * @method EventTheme getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseEventThemeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('event_theme[%s]');
