...
/**
 * Competence form base class.
 *
 * @method Competence getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseCompetenceForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        new sfValidatorDoctrineUnique(array('model' => 'Competence', 'column' => array('nom'))),
        new sfValidatorDoctrineUnique(array('model' => 'Competence', 'column' => array('slug'))),
      ))
    );

    $this->widgetSchema->setNameFormat('competence[%s]');
