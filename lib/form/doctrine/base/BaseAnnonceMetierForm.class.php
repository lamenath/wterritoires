...
/**
 * AnnonceMetier form base class.
 *
 * @method AnnonceMetier getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseAnnonceMetierForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('annonce_metier[%s]');
