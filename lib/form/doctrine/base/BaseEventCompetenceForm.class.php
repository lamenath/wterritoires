...
/**
 * EventCompetence form base class.
 *
 * @method EventCompetence getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseEventCompetenceForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('event_competence[%s]');
