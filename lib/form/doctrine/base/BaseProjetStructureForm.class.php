...
/**
 * ProjetStructure form base class.
 *
 * @method ProjetStructure getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseProjetStructureForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('projet_structure[%s]');
