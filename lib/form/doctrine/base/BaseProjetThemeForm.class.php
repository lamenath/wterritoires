...
/**
 * ProjetTheme form base class.
 *
 * @method ProjetTheme getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseProjetThemeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('projet_theme[%s]');
