...
/**
 * StoryBuddies form base class.
 *
 * @method StoryBuddies getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseStoryBuddiesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('story_buddies[%s]');
