...
/**
 * MailingFiliere form base class.
 *
 * @method MailingFiliere getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseMailingFiliereForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'mailing_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Mailing'), 'required' => false)),
      'created_at' => new sfValidatorDateTime(),
      'updated_at' => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('mailing_filiere[%s]');
