...
/**
 * ActionPassword form base class.
 *
 * @method ActionPassword getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseActionPasswordForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('action_password[%s]');
