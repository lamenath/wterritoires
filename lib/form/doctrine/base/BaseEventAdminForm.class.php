...
/**
 * EventAdmin form base class.
 *
 * @method EventAdmin getObject() Returns the current form's model object
 *
 * @package    rrr
 * @subpackage form
 ...
 */
abstract class BaseEventAdminForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('event_admin[%s]');
