 ...
 *
 *modifé pour RRR par simon lamelliere
 *
 * Requires: jQuery 1.2+
 *
...
(function($) {
	$.humanize = function(msg,options){
		...
		window.setTimeout($.humanize.remove, 3200); 
	};
	$.humanize.defaults = {
		baseSelector : '.feedback',
		container : '<p class="feedback">&nbsp;</p>',
		fadeIn : {easing:'swing', duration:500},
		fadeOut : {easing:'swing', duration:500,complete:function(){$(this).remove()}},
		opacity : 0.7,
		movementThreshold : 3
	};
