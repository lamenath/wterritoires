<div class="content-popin">
	...
	<div class="generic">
		<form action="<?php echo url_for("json/admin_project"); ?>" method="post" class="ajaxForm">
			<div class="contacts">
				...
				<h2 class="up"><?php
					...
					if($sf_request->getParameter("direction") == "kick")
						echo __("Exclure %1% du projet %project?", array("%project" => $project["nom"], "%1%" => $profil["full_name"]) );
					elseif($sf_request->getParameter("direction") == "referent")
						echo __("Souhaitez-vous vraiment nommer %1% comme référent du projet %project?", array("%project" => $project["nom"], "%1%" => $profil["full_name"]) );
