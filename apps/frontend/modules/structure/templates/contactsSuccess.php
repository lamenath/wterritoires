	...
	<div class="content">
		<div class="title">
			<a href='<?php echo $structure["url"]; ?>'>
				<?php echo image_tag($structure["photo_std"], array("alt" => __("Photo d'illustration"), "class" => "user")); ?>
				<div class="block">
			...
			<div class="carousel">
				<div class="content-fixed">
					<div class="common-feed">
						<?php include_partial("structure/contacts", array("structure" => true, "acl" => $structure["ACL"], "total" => $total, "pager" => $pager)); ?>
					</div>
				</div>
				<div class="clear"></div>
